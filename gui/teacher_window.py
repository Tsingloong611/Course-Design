...
class TeacherWindow:
    ...
    def course_center_page(self):
        ...
        upload_materials_button = tk.Button(page, text="上传资料",
        ...
        show_homework_button = tk.Button(page, text="查看作业",
        ...
        confirm_two_id_entry = tk.Entry(page, textvariable=confirm_two_id)
